...
def ProxyGit():
    global URL 
    print("==============  ProxyGit start...   ==============")
    URL = input("输入反向代理地址需要连/一起复制(没有就直接回车):")
...
def installNode(docker_mode=False):
    ...
    if if_exist_fisco == "no":
        ...
        gitComm = "wget {}https://github.com/FISCO-BCOS/FISCO-BCOS/releases/download/{}/build_chain.sh && chmod u+x build_chain.sh".format(URL,fisco_version)
...
def installWeb():
    ...
    gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/webase-web.zip".format(URL,web_version)
    ...
    if web_h5_enable == 1:
        ...
        gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/webase-web-mobile.zip".format(URL,web_version)
...
def installManager(visual_deploy=False):
    ...
    gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/webase-node-mgr.zip".format(URL,mgr_version)    
...
def installFront():
    ...
    gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/webase-front.zip".format(URL,front_version)    
...
def installSign():
    ...
    gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/webase-sign.zip".format(URL,sign_version)    
...
def installDockerImage():
    ...
    if (ifLoad == "yes"):
        ...
        gitComm = "wget {}https://github.com/WeBankBlockchain/WeBASELargeFiles/releases/download/{}/docker-fisco-webase.tar".format(URL,image_version)    
